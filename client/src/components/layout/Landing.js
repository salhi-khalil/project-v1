    ...
    return (
        ...
        <div className="dark-overlay">
            <div className="landing-area-inner">
                ...
                <p className="guide">Create a doctor or a patient profile, take an appointment and visit our directory</p>
                <div className="buttons">
                    <Link to="/Choose" className=" button button-primary">Sign Up</Link>
